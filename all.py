...
os.system('python merge/1.py && python merge/2.py && python merge/3.py')
os.system('python seprate/start.py')

os.system('python name/ssn.py')
...
os.system('python name/hy2name.py')
os.system('python name/hy.py')
...
os.system('python dup/rem.py && python dup/rem2.py')
